...
| apigw.initJVMHeap | string | `"1024Mi"` | Set JVM minimum heap size for 11.x images  |
| apigw.initMemory | string | `"1024Mi"` | Set JVM minimum heap size for 10.15 images  |
...
| apigw.maxJVMHeap | string | `"1024Mi"` | Set JVM maximum heap size for 11.x images  |
| apigw.maxMemory | string | `"1024Mi"` | Set JVM maximum heap size for 10.15 images  |
