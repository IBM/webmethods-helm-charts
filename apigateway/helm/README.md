...
| routes | object | `{"admin":{"annotations":{},"enabled":false,"hostName":"","labels":{},"name":"","portName":"adminport","tls":{"caCertificate":"","certificate":"","destinationCACertificate":"","insecureEdgeTerminationPolicy":"Redirect","key":"","termination":null}},"ui":{"annotations":{},"enabled":false,"hostName":"","labels":{},"name":"","portName":"uiport","tls":{"caCertificate":"","certificate":"","destinationCACertificate":"","insecureEdgeTerminationPolicy":"Redirect","key":"","termination":null}}}` | Route for admin, ui port for openshift Example configurations:  1. Basic HTTPS with auto-generated certificates:    routes:      ui:        enabled: true        hostName: apigw-ui.apps.cluster.example.com        tls:          termination: edge          insecureEdgeTerminationPolicy: Redirect  2. HTTPS with custom certificate:    routes:      ui:        enabled: true        hostName: apigw-ui.example.com        tls:          termination: edge          insecureEdgeTerminationPolicy: Redirect          certificate: |            -----BEGIN CERTIFICATE-----            ...          key: |            -----BEGIN PRIVATE KEY-----            ...  3. Mutual TLS (mTLS) with client certificate validation:    routes:      admin:        enabled: true        hostName: apigw-admin.example.com        tls:          termination: edge          insecureEdgeTerminationPolicy: None          certificate: |            -----BEGIN CERTIFICATE-----            ...          key: |            -----BEGIN PRIVATE KEY-----            ...          caCertificate: |            -----BEGIN CERTIFICATE-----            ...  4. Passthrough TLS (backend handles TLS):    routes:      ui:        enabled: true        hostName: apigw-ui.apps.cluster.example.com        tls:          termination: passthrough  5. Re-encrypt (TLS at router and backend):    routes:      ui:        enabled: true        hostName: apigw-ui.apps.cluster.example.com        tls:          termination: reencrypt          insecureEdgeTerminationPolicy: Redirect          destinationCACertificate: |            -----BEGIN CERTIFICATE-----            ... |
| routes.admin | object | `{"annotations":{},"enabled":false,"hostName":"","labels":{},"name":"","portName":"adminport","tls":{"caCertificate":"","certificate":"","destinationCACertificate":"","insecureEdgeTerminationPolicy":"Redirect","key":"","termination":null}}` | Route for API Gateway Admin Port |
| routes.ui | object | `{"annotations":{},"enabled":false,"hostName":"","labels":{},"name":"","portName":"uiport","tls":{"caCertificate":"","certificate":"","destinationCACertificate":"","insecureEdgeTerminationPolicy":"Redirect","key":"","termination":null}}` | Route for API Gateway UI Port |
